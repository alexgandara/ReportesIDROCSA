...
public class v21readXML {
	...
	public static factura_detalle_email[] Detalle_email = new factura_detalle_email[300];
	public static reglones[] misReglones = new reglones[10];
	public static palabras[] arregloPalabras = new palabras[300];
...
//				}
	...
	//		System.out.println("Pais del Emisor_ _ _ _ _ _ _ _ : " + Cabecera.get_pais_emisor());
			...
			if (Cabecera.get_tipo_doc().substring(1).equals("1")) {
				...
				NodeList nodeList_AccountingCustomerParty = doc.getElementsByTagName("cac:AccountingCustomerParty").item(0).getChildNodes();
				Node nNode_AccountingCustomerParty = nodeList_AccountingCustomerParty.item(0);
				String _RUC_RECEPTOR=nNode_AccountingCustomerParty.getTextContent().substring(0, 8);
				Cabecera.set_ruc_receptor(_RUC_RECEPTOR);
				System.out.println("DNI del Receptor_ _ _ _ _ _ _ _: " + Cabecera.get_ruc_receptor());
			...
			NodeList nList_MultiplierFactorNumeric = doc.getElementsByTagName("cbc:MultiplierFactorNumeric");
			try {
				Node nNode_MultiplierFactorNumeric = nList_MultiplierFactorNumeric.item(0);
				Cabecera.set_porciento_descuento(Double.parseDouble(nNode_MultiplierFactorNumeric.getTextContent()));
				
				
			}  catch (Exception e) {
				Cabecera.set_porciento_descuento(0);
...
//			System.out.println("Importe Descuentos _ _ _ _ _ _: " + Cabecera.get_total_descuentos());
		...
		//	Cabecera.set_total(_PayableAmount_total);
			...
			Cabecera.set_total(Double.parseDouble(nNode_TaxInclusiveAmount.getTextContent()));
			System.out.println("Total Documento _ _ _ _ _ _ _ _ _ _ _ _ _: " + Cabecera.get_total());
...
//			System.out.println("O. REPARACION_ _ _ _: " + Cabecera.get_reparacion());
			...
			// tipo de opecaion
			 ...
			 Cabecera.set_sello(Cabecera.get_ruc_emisor()+"|"+
				...
				for (int _linea = 0; _linea < nList_linea.getLength(); _linea++) {
					...
					System.out.println(nNode_linea.toString()+"  "+_linea+"   "+_lineaArreglo);
	...
	//		Cabecera.set_total_descuentos(Cabecera.get_descuentos_detalle()+Cabecera.get_descuentos_cabecera() );
			...
			Cabecera.set_total_descuentos(Cabecera.get_descuentos_cabecera() );
		...
		//		}
				...
				printPDFA4.imp_factura(_file_xml, Cabecera, Detalle, _lineas_Descripcion,_file_pdf_para_imprimir, _file_jpg_para_membrete, Rel);
