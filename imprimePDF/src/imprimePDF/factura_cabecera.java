...
public class factura_cabecera {
	...
	public String get_fecha_doc_rel() {
		return _fecha_doc_rel;
	}
	public void set_fecha_doc_rel(String _fecha_doc_rel) {
		this._fecha_doc_rel = _fecha_doc_rel;
	}
